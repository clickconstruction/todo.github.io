...
(function () {
  ...
  const DEFAULTS = {
    ...
    events: () => ({ notes: '', location: '', url: '', all_day: false, project_id: null, place_id: null, task_id: null, source: 'app', archived_at: null }),
    ...
    people: () => ({ email: null, phone: null, notes: '', tag_id: null, sort: 0, archived_at: null, added_via: 'app' }),
