...
export const db = { tasks: [], projects: [], folders: [], tags: [], taskTags: [], projectTags: [], places: [], notifications: [], attachments: [], perspectives: [], templates: [], calendars: [], people: [], references: [], weeklyReviews: [], areas: [], goals: [], checklists: [], checklistRuns: [], dailyReviews: [], imports: [], slipbox: [], reviewSessions: [], events: [] };
