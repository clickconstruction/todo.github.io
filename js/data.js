...
export async function loadAll() {
  ...
  const [tasks, projects, folders, tags, taskTags, projectTags, places, notifications, attachments] = await Promise.all([
  ...
  Object.assign(db, { tasks, projects, folders, tags, taskTags, projectTags, places, notifications, attachments });
}
